        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="/OnlineMovieSystem/movie?action=admin" class="btn btn-primary">Go to Movie Management</a>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="/OnlineMovieSystem/package?action=admin" class="btn btn-primary">Go to Package Management</a>
                </div>
            </div>
        </div>
